            ...
            {<footer className="bg-dark text-center text-white footer" >
                <div className="container p-4">
                    <section className="mb-4">
                        ...
                        <a target="_blank" rel="noreferrer" className="btn btn-outline-light btn-floating m-1 aImgIconFooter" href="https://github.com/HenryDelaossa/celucommerce" role="button">
