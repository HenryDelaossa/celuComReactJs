...
import { formatAPesCol, scrollArriba, OptionsBanq, deleteOtherPaymentMethod, validaInpts, habilbtnContinuarInfoClient, habilbtnContinuarDatosEnvio, mapLabelInputInfoClient, mapLabelInputDatosEnvio, mapLabelInputPayTarjetaCredito, mapLabelInputPayPSE, habilSubmitRegex } from '../../Helpers/Helpers'
                    ...
                    <form onSubmit={handSbmt} >
                        <div className="intenrDivsCheckout divInfoClient">
                            <div className='divTitCheckout' >
                                <b>Esta compra: ${formatAPesCol(totalShop)}</b>
                                <h5>CHECKOUT</h5>
                                <div className='divMethPago'>
                                    <div style={{ backgroundColor: infoClient && "#004797" }}>
                                        <b className={infoClient ? "liCheckClientInfoAct" : "liCheck"}>Informacion Del Cliente</b>
                                    </div>
                                    <div style={{ backgroundColor: datosEnvio && "#004797" }}>
                                        <b className={datosEnvio ? "liCheckDatEnvioAct" : "liCheck"} >Datos de envio</b>
                                    </div>
                                    <div style={{ backgroundColor: datesPago && "#004797" }}>
                            ...
                            {payEfectivo && <div className='divCtnLblInput' >
                                <h3>Uno de nuestros asesores se comunicara contigo al numero telefonico brindado, verifica que este correctamente escrito para mayor efectividad al contactarte.</h3>
        ...
        }
            {
                ...
                <div className='ctnDivOkayAll'>
                    <div className='divOkayAll'>
                        <h1>Felicidades, tu proceso de pago se ha realizado con exito</h1>
                        <p>Codigo de tu orden: <b>{idOrden}</b></p>
